...
namespace {
    ...
    /**
     * View that fetches a single asset from the asset manager and returns it as a
     * response.
     */
    const class asset : public fostlib::urlhandler::view {
    public:
        asset()
        : view("fost.andriod.asset") {
        }
        ...
        std::pair<boost::shared_ptr<fostlib::mime>, int> operator () (
            ...
            fostlib::string assetpath = fostlib::coerce<fostlib::string>(config);
